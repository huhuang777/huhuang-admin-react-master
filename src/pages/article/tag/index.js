...
@Form.create()
@connect(({ tagsList, loading }) => ({ tagsList, loading }))
class AllTags extends PureComponent {
  ...
  delete(id = []) {
    const { dispatch, tagsList } = this.props
    if (id.length <= 0) {
      const { selectedRowKeys } = tagsList
      id = selectedRowKeys
    }
  ...
  handleSubmit = e => {
    const { dispatch, tagsList, form } = this.props
    const { currentItem } = tagsList
    e.preventDefault()
  ...
  render() {
    const { form, loading, tagsList } = this.props
                    ...
                    <div className={styles.extendsBox}>
                      ...
                      <Col span={6}>
                        <Button
                          ...
                          loading={
                            !!_id
                              ? loading.effects['tagsList/edit']
                              : loading.effects['tagsList/delete']
                          }
                        >
                          重置
                        </Button>
          ...
          <Col xl={16} lg={24} md={24} sm={24} xs={24}>
            <Card title="标签管理" bordered={false}>
              ...
              <Table
                ...
                loading={loading.effects['tagsList/query']}
                dataSource={list}
                pagination={{
                  ...pagination,
